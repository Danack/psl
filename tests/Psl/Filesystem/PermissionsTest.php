...
final class PermissionsTest extends AbstractFilesystemTest
{
    ...
    public function testChangePermissionsRecursively(): void
    {
        $directory = Str\join([$this->directory, 'foo'], Filesystem\SEPARATOR);
        $filename = Str\join([$this->directory, 'foo', 'bar.txt'], Filesystem\SEPARATOR);
        ...
        Filesystem\change_permissions($directory, 0777, true);
