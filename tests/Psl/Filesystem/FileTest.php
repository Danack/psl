...
final class FileTest extends AbstractFilesystemTest
{
    ...
    public function testWriteFile(): void
    {
        ...
        Filesystem\write_file($file, ', World!', true);
    ...
    public function testReadFile(): void
    {
        ...
        Filesystem\write_file($file, ' - a modern, consistent, centralized', true);
        Filesystem\write_file($file, ' well-typed set of APIs for PHP programmers.', true);
